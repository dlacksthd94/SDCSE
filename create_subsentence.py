...
with open(f'wiki1m_for_simcse_tree_cst_lg.pickle', 'rb') as f:
    list_tree = pickle.load(f)
...
with open(f'wiki1m_for_simcse_tree_cst_lg_nltk.pickle', 'wb') as f:
    pickle.dump(list_tree_nltk, f)

with open(f'wiki1m_for_simcse_tree_cst_lg_nltk.pickle', 'rb') as f:
...
with open(f'wiki1m_for_simcse_tree_cst_lg_subsentence.pickle', 'wb') as f:
