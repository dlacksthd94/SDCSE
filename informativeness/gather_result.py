            ...
            for lr in [dict_lr[ENCODER][plm]]:
                for epoch in dict_meta[ENCODER]['list_epoch']:
                    for max_len in dict_meta[ENCODER]['list_max_len']:
                        for lambda_w in dict_meta[ENCODER]['list_lambda_w']:
                                                ...
                                                for pooler in dict_meta[ENCODER]['list_pooler']:
                                                    for metric in dict_meta[ENCODER]['list_metric']:
                                                        for margin in dict_meta[ENCODER]['list_margin']:
                                                            for lambda_w2 in dict_meta[ENCODER]['list_lambda_w2']:
                                                            ...
                                                            for metric in dict_meta[ENCODER]['list_metric']:
                                                                for margin in dict_meta[ENCODER]['list_margin']:
                                                                    for lambda_w2 in dict_meta[ENCODER]['list_lambda_w2']:
                                                                        for mask_ratio in dict_meta[ENCODER]['list_mask_ratio']:
                                                                            try:
                                                                                # plm, mode, taskset, bs, lr, epoch, seed, max_len, lambda_w, pt_type, pt_num, pt_step, loss, pooler, metric, margin, lambda_w2, mask_ratio = 'bert_base', 'test', 'full', 128, '7e-6', 2, 0, 32, '0e-0', 'none', 0, 0, 'mse', 'wp', 'stsb', '0e-0', '5e-3', '3e-1' # DiffCSE
                                                                                if ENCODER == 'SimCSE':
