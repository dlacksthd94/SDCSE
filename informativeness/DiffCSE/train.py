...
from diffcse.models import RobertaForCL, BertForCL, CustomDropout
...
class ModelArguments:
    ...
    lambda_weight_diffcse: float = field(
        default=0.1,
        metadata={
    ...
    # SDCSE's arguments
    lambda_weight_sdcse: float = field(
        default=1,
        metadata={
...
#     # '--model_name_or_path', f'result/backup_eval_dropout_sim0_nocls/my-unsup-diffcse-bert-base-uncased_128_7e-6_2_0_32_1e-0_dropout_1_1_margin_wp_stsb_1e-0_5e-3_3e-1',
#     '--generator_name', 'distilbert-base-uncased',
#     '--train_file', dict_data[PERTURB_TYPE],
#     '--output_dir', f'result/my-unsup-diffcse-{dict_plm[PLM]}_{BATCH_SIZE}_{LR}_{EPOCH}_{SEED}_{MAX_LEN}_{LAMBDA}_{LAMBDA2}_{MASK_RATIO}',
...
#     '--do_eval',
#     '--batchnorm',
#     '--lambda_weight_diffcse', str(LAMBDA_DIFFCSE),
#     '--masking_ratio', str(MASK_RATIO),
#     # '--eval_transfer',
#     '--fp16',
#     '--seed', str(SEED),
#     # '--no_cuda',
#     '--no_remove_unused_columns',
#     '--lambda_weight_sdcse', str(LAMBDA_SDCSE),
