...
def cl_forward(cls,
    ...
    # cls,encoder,position_ids,head_mask,inputs_embeds,labels,output_attentions,output_hidden_states,return_dict,mlm_input_ids,mlm_labels,cls_token=model,model.bert,None,None,None,None,None,None,None,None,None,101
    # attention_mask, input_ids, token_type_ids, mlm_input_ids, mlm_labels = next(iter(train_dataloader)).values() 
    # input_ids, attention_mask, token_type_ids, mlm_input_ids, mlm_labels = input_ids.cuda(), attention_mask.cuda(), token_type_ids.cuda(), mlm_input_ids.cuda(), mlm_labels.cuda()
    ...
    if mlm_outputs is not None and mlm_labels is not None:
        ...
        loss = loss + cls.model_args.lambda_weight_diffcse * masked_lm_loss
