...
list_dataset = ['wiki1m', 'STS12', 'STS13', 'STS14', 'STS15', 'STS16', 'STS-B', 'SICK-R', 'quora', 'simplewiki', 'specter', 'covid']
...
if MODE == 'sub':
    ...
    df_result = pd.DataFrame(columns=[list(chain.from_iterable(zip(list_encoder, list_encoder))), list_plm * 4], index=list_dataset)
