...
if not os.path.exists(f'data/wiki1m_tree_dpd.pickle'):
    ...
    with open(f'data/wiki1m_tree_dpd.pickle', 'wb') as f:
...
with open(f'data/wiki1m_tree_dpd_depth.pickle', 'wb') as f:
