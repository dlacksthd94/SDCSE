...
from covid_q.code.methods import clean_line, save_to_pickle, read_csv, read_pickle
...
# [PromCSE] Gets all encodings given an input csv
def get_all_embeddings_promcse(input_csv, model):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name_or_path", type=str, 
            default='model/my-unsup-promcse-bert-base-uncased', # 추가
    ...
    input_csv = '../covid_q/data/final_master_dataset_1599.csv'

    all_embeddings = get_all_embeddings_promcse(input_csv, model)
    model_name_split = 'my-unsup-promcse-bert-base-uncased' # 모델 한 종류밖에 없으므로 이걸로 고정
    save_to_pickle(all_embeddings, f'../covid_q/data/question_embeddings_promcse_{model_name_split}.pickle')
    print(f'Successfully saved question_embeddings_promcse_{model_name_split}.pickle')
